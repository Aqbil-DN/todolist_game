    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white font-sans crt overflow-hidden pixel-grid relative selection:bg-[#FFD60A] selection:text-black">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-[#00B4FF]/30 bg-[#0D0D0D]/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 font-pixel text-[#5CE1E6] drop-shadow-[0_0_5px_#5CE1E6]">
          ...
          <button className="bg-[#6A4CFF] text-white font-pixel text-xs py-3 px-6 comic-shadow-yellow btn-comic flex items-center gap-2 border-2 border-white">
      ...
      <footer className="relative pt-32 pb-20 px-6 bg-black text-white overflow-hidden border-t-8 border-[#00B4FF]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <button className="bg-[#6A4CFF] text-white font-pixel text-sm md:text-xl py-6 px-12 comic-shadow-yellow btn-comic flex items-center gap-4 group border-2 border-white mt-4">
            ENTER THE SYSTEM
